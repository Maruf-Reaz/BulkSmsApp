...
<aside class="menu-sidebar d-none d-lg-block">
    <div class="logo">
        <a style="padding-top: 13px;" href="<?php echo URLROOT; ?>/">
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 886 317.9" style="enable-background:new 0 0 886 317.9;width: 100px; margin-left: 28px;margin-top: 5px;" xml:space="preserve">
                <style type="text/css">
                    .st0 {
                        fill: #85CE36;
                    }
            ...
            <ul class="nav-left list-unstyled navbar__list">
                ...
                <li>
                    <a href="<?php echo URLROOT; ?>/">
                        <i style="width: 20px" class="fas fa-window-restore "></i>Dashboard</a>
                </li>
                
                
                <li>
                    <a href="<?php URLROOT; ?>/Smses/addTemplate">
                        <i style="width: 20px" class="fas fa-plus-circle "></i>Add SMS Template</a>
                </li>
                
                <li>
                    <a href="<?php URLROOT; ?>/Smses/index">
                        <i style="width: 20px" class="fas fa-eye"></i>View SMS Template</a>
                </li>
                
                <li>
                    <a href="<?php URLROOT; ?>/smses/sendSms">
                        <i style="width: 20px" class="fas fa-share-square "></i>Send Mass SMS</a>
                </li>
                <li>
                    <a href="<?php URLROOT; ?>/smses/sendIndividualSms">
                        <i style="width: 20px" class="fas fa-share-square "></i>Send Individual Sms</a>
                </li>
                <li>
                    <a href="<?php URLROOT; ?>/smses/getSmsHistory">
                        <i style="width: 20px" class="fas fa-history"></i>SMS History</a>
                </li>
                ...
                <li>
                    <a href="##">
                        <i style="width: 20px" class="fas fa-users "></i>User</a>
                </li>
                
                <li>
                    <a href="##">
                        <i style="width: 20px" class="fas fa-cogs "></i>Setting</a>
                </li>
            </ul>
        </nav>
    </div>
